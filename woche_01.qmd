...
**Ohne Zurücklegen:**.  
Ein Zahlenschloss, bei dem jede Zahl nur einmal gewählt werden kann $(N = 10*9*8)$ für ein 3-stelliges Schloss.

**Mit Zurücklegen:**.  
Ein Zahlenschloss, bei dem jede Zahl mehrfach gewählt werden kann. $(N = 10*10*10)$ für ein 3-stelliges Schloss.
